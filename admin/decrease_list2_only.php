...
if  ($item_id) {
	...
	//全部已填的減免資料
	$data['decase_list'] = get_all_decrease_list_item_kind_array( $item_id ,'only') ;
	...
	$objActSheet->setTitle("依項目減免");  //設定標題	
      ...
      //標題行
        ...
        $objActSheet->setCellValue('J1', '原因') ;
	...
	header('Content-Disposition: attachment;filename=dec_kind_o_'.date("mdHi").'.xls' );

CREATE TABLE `charge_item` (
  ...
  `p_rec_num` int(11) NOT NULL,
  `p_sum` int(11) NOT NULL,
  `c_rec_num` int(11) NOT NULL,
  `c_sum` int(11) NOT NULL,
  PRIMARY KEY (`item_id`)
) ENGINE=MyISAM   ;
...
CREATE TABLE `charge_record` (
    ...
    `class_id` varchar(6) COLLATE utf8mb4_unicode_ci NOT NULL,
    `cause` int(11) NOT NULL DEFAULT '0',
    `ps` varchar(200) COLLATE utf8mb4_unicode_ci NOT NULL,
    `rec_name` varchar(20) COLLATE utf8mb4_unicode_ci NOT NULL,
...
CREATE TABLE   `charge_account` (
    ...
    `acc_name` varchar(30) COLLATE utf8mb4_unicode_ci NOT NULL,
    `acc_person_id` varchar(12) COLLATE utf8mb4_unicode_ci NOT NULL,
    `acc_mode` char(1) COLLATE utf8mb4_unicode_ci NOT NULL,
    `acc_b_id` varchar(20) COLLATE utf8mb4_unicode_ci NOT NULL,
    `acc_id` varchar(20) COLLATE utf8mb4_unicode_ci NOT NULL,
    `acc_g_id` varchar(20) COLLATE utf8mb4_unicode_ci NOT NULL,
    PRIMARY KEY (`stud_sn`),
    KEY `a_id` (`a_id`)
...
CREATE TABLE  `charge_poster_data` (
    ...
    `sit_num` int(11) NOT NULL,
    `st_name` varchar(30) COLLATE utf8mb4_unicode_ci NOT NULL,
    `pay` int(11) NOT NULL,
    `acc_name` varchar(30) COLLATE utf8mb4_unicode_ci NOT NULL,
    `acc_personid` varchar(20) COLLATE utf8mb4_unicode_ci NOT NULL,
    `acc_mode` varchar(10) COLLATE utf8mb4_unicode_ci NOT NULL,
    `acc_b_id` varchar(20) COLLATE utf8mb4_unicode_ci NOT NULL,
    `acc_id` varchar(20) COLLATE utf8mb4_unicode_ci NOT NULL,
    `acc_g_id` varchar(20) COLLATE utf8mb4_unicode_ci NOT NULL,

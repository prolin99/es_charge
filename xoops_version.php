...
$modversion['release_date'] = '2026-09-2';
...
$modversion['config'][$i]['formtype'] = 'textarea';
$modversion['config'][$i]['valuetype'] = 'text';
$modversion['config'][$i]['default'] = "特殊身份者才能勾選[申請補助]。無需繳費的減免(如家長費不用繳)，不要勾選[申請補助]。各項減免需要附上當年度本市身份證明文書。<br />\r\n點選<span class='fa fa-forward' ></span>輸入金額或清空，也可以直接輸入金額。<br />\r\n如果有多項身份別，請在該項補助後<span  class='fa fa-filter'></span>切換顯示，再指定其他減免身份。 ";
++$i;
